...
astyle --suffix=none --style=ansi --indent=spaces=2 --indent-switches --pad-oper --break-closing-brackets --max-instatement-indent=40 lib/src/Uncertainty/Algorithm/Simulation/NAIS.?xx
