...
PATH=~/.local/bin/:$PATH flake8 python/ --ignore=W503 --max-line-length=250

PATH=~/.local/bin/:$PATH doc8 python/doc/ --ignore D000 --ignore-path python/doc/theory/meta_modeling/orthogonal_polynomials.rst --max-line-length 250
