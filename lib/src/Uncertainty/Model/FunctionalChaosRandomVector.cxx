...
{
  if (!functionalChaosResult_.getUseTransformation())
    throw NotYetImplementedException(HERE) << "FunctionalChaosRandomVector.computeCovariance is not available without transformation method.";
