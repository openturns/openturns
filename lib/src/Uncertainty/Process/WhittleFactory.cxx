...
void WhittleFactory::initializeCobylaSolverParameter()
{
  ...
  solver_.setMaximumCallsNumber(ResourceMap::GetAsUnsignedInteger("WhittleFactory-DefaultMaximumCallsNumber"));
}
...
ARMA WhittleFactory::maximizeLogLikelihood(Point & informationCriteria) const
{
  ...
  Point bestInformationCriteria(3, SpecFunc::Infinity);
