  ...
  , optimizationBounds_(optimizationBounds)
{
  ...
  solver_.setMaximumCallsNumber(ResourceMap::GetAsUnsignedInteger("MethodOfMomentsFactory-MaximumCallsNumber"));
...
public:
  ...
  MethodOfMomentsEvaluation * clone() const override
  {
