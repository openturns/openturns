 ...
 *
 */
#ifndef OPENTURNS_GENERALIZEDPARETOVALIDATION_HXX
#define OPENTURNS_GENERALIZEDPARETOVALIDATION_HXX
...
class OT_API GeneralizedParetoValidation
...
public:
  ...
  GeneralizedParetoValidation(const DistributionFactoryResult & result,
                              const Sample & sample);

  GeneralizedParetoValidation * clone() const override;
...
#endif /* OPENTURNS_GENERALIZEDPARETOVALIDATION_HXX */
