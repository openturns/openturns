...
class OT_API ConditionalDistribution
  : public DeconditionedDistribution
{
  CLASSNAME
public:
  ...
  ConditionalDistribution(const Distribution & conditionedDistribution,
                          const Distribution & conditioningDistribution)
    : DeconditionedDistribution(conditionedDistribution, conditioningDistribution) {}

  /** Default constructor */
  ConditionalDistribution(const Distribution & conditionedDistribution,
                          const Distribution & conditioningDistribution,
                          const Function & linkFunction)
    : DeconditionedDistribution(conditionedDistribution, conditioningDistribution, linkFunction) {}
