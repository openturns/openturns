 ...
 *
 */
#ifndef OPENTURNS_BERNSTEINCOPULA_HXX
#define OPENTURNS_BERNSTEINCOPULA_HXX
...
public:
  ...
  /** Comparison operator */
  Bool operator ==(const BernsteinCopula & other) const;
protected:
...
public:
  ...
  /** Virtual constructor */
  virtual BernsteinCopula * clone() const;
...
#endif /* OPENTURNS_BERNSTEINCOPULA_HXX */
