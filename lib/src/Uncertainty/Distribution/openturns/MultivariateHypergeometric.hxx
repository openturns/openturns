 ...
 *
 */
#ifndef OPENTURNS_MULTIVARIATEHYPERGEOMETRIC_HXX
#define OPENTURNS_MULTIVARIATEHYPERGEOMETRIC_HXX
 ...
 *
 * The MultivariateHypergeometric distribution.
 */
class OT_API MultivariateHypergeometric
...
public:
  ...
  MultivariateHypergeometric(const UnsignedInteger n,
                             const Point & colors);
  ...
  Bool operator ==(const MultivariateHypergeometric & other) const;
protected:
...
public:
  ...
  /** Virtual constructor */
  MultivariateHypergeometric * clone() const override;
  ...
  /* Interface specific to MultivariateHypergeometric */

  /** Colors vector accessor */
  void setColors(const Point & colors);
  Point getColors() const;

  /** Total population accessor */
  void setTotal(const UnsignedInteger total);
  UnsignedInteger getTotal() const;
...
private:
  ...
  /** The vector of population counts of the MultivariateHypergeometric distribution */
  Point colors_;

  /** The total population size, greater or equal to the sum of colors */
  Scalar total_;

  /** The ratio n_ / total_, parameter of the underlying Binomial distributions */
  Scalar t_;
...
#endif /* OPENTURNS_MULTIVARIATEHYPERGEOMETRIC_HXX */