...
NumericalPoint Wishart::getParameters() const
{
  const CovarianceMatrix V(getCovariance());
...
void Wishart::setParameters(const NumericalPoint & parameters)
{
...
Description Wishart::getParametersDescription() const
{
