...
GaussianProcessRegressionResult::GaussianProcessRegressionResult(const Sample &inputSample,
                                                                 ...
                                                                 const UnsignedInteger linearAlgebraMethod)
    : MetaModelResult(inputSample, outputSample, metaModel, residuals, relativeErrors),
      gpfResult_(inputSample, outputSample, metaModel, residuals, relativeErrors, regressionMatrix, basis, trendCoefficients, covarianceModel, rho, optimalLogLikelihood, linearAlgebraMethod),
...
Function GaussianProcessRegressionResult::getTrendFunction() const
{
  return gpfResult_.getTrendFunction();
}
...
UnsignedInteger GaussianProcessRegressionResult::getLinearAlgebraMethod() const
{
...
void GaussianProcessRegressionResult::setCholeskyFactor(const TriangularMatrix &covarianceCholeskyFactor,
                                                        const HMatrix &covarianceHMatrix)
{
  gpfResult_.setCholeskyFactor(covarianceCholeskyFactor, covarianceHMatrix);
}
