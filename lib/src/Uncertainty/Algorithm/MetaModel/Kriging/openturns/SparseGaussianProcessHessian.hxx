 ...
 *
 */
#ifndef OPENTURNS_SPARSEGAUSSIANPROCESSHESSIAN_HXX
#define OPENTURNS_SPARSEGAUSSIANPROCESSHESSIAN_HXX
...
/**
 * @class SparseGaussianProcessHessian
 *
 * This class computes the hessian of the sparse gaussian process prediction
 */
class OT_API SparseGaussianProcessHessian
...
public:
  ...
  /** Default constructor */
  SparseGaussianProcessHessian();

  /** Constructor with parameters */
  SparseGaussianProcessHessian(const CovarianceModel & covarianceModel,
  ...
  /** Virtual constructor */
  SparseGaussianProcessHessian * clone() const override;

  /** Comparison operator */
  using HessianImplementation::operator ==;
  Bool operator ==(const SparseGaussianProcessHessian & other) const;
protected:
