...
UnsignedInteger GaussianProcessFitterResult::getLinearAlgebraMethod() const
{
...
void GaussianProcessFitterResult::save(Advocate & adv) const
{
  ...
  adv.saveAttribute("linearAlgebraMethod_", linearAlgebraMethod_);
...
void GaussianProcessFitterResult::load(Advocate & adv)
{
  ...
  adv.loadAttribute("linearAlgebraMethod_", linearAlgebraMethod_);
