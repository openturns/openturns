//                                               -*- C++ -*-
/**
 *  @brief CrossEntropyImportanceSamplingAlgorithm implement parent class for Cross Entropy Importance Sampling algorithms
 *
...
/**
 * @class CrossEntropyImportanceSamplingAlgorithm
 */

CLASSNAMEINIT(CrossEntropyImportanceSamplingAlgorithm)

static const Factory<CrossEntropyImportanceSamplingAlgorithm> Factory_CrossEntropyImportanceSamplingAlgorithm;

// Default constructor
CrossEntropyImportanceSamplingAlgorithm::CrossEntropyImportanceSamplingAlgorithm()
  : EventSimulation()
{
  // Nothing TO DO
}
...
// Default constructor
CrossEntropyImportanceSamplingAlgorithm::CrossEntropyImportanceSamplingAlgorithm(const RandomVector & event,
...
/* Virtual constructor */
CrossEntropyImportanceSamplingAlgorithm * CrossEntropyImportanceSamplingAlgorithm::clone() const
{
  return new CrossEntropyImportanceSamplingAlgorithm(*this);
}

// Get rhoQuantile
Scalar CrossEntropyImportanceSamplingAlgorithm::getRhoQuantile() const
{
  return rhoQuantile_;
}

// Set rhoQuantile
void CrossEntropyImportanceSamplingAlgorithm::setRhoQuantile(const Scalar & rhoQuantile)
{
  rhoQuantile_ = rhoQuantile;
}

// Compute Output Samples
Sample CrossEntropyImportanceSamplingAlgorithm::computeOutputSamples(const Sample & inputSamples) const
{
  throw NotYetImplementedException(HERE) << "In CrossEntropyImportanceSamplingAlgorithm::computeOutputSamples(const Sample & inputSamples)";
}

// Update auxiliary distribution
void CrossEntropyImportanceSamplingAlgorithm::updateAuxiliaryDistribution(const Point & auxiliaryDistributionParameters)
{
  throw NotYetImplementedException(HERE) << "In CrossEntropyImportanceSamplingAlgorithm::updateAuxiliaryDistribution(const Point & auxiliaryDistributionParameters)";
} 
  
// Optimize auxiliary distribution parameters
Point CrossEntropyImportanceSamplingAlgorithm::optimizeAuxiliaryDistributionParameters(const Sample & auxiliaryInputSamples) const
{
...
void CrossEntropyImportanceSamplingAlgorithm::run()
{
...
// Accessor to CrossEntropyImportanceSamplingAlgorithm Result_s
CrossEntropyResult CrossEntropyImportanceSamplingAlgorithm::getResult() const
{
