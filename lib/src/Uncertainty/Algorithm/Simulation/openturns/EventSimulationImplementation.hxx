 ...
 *
 */
#ifndef OPENTURNS_EVENTSIMULATIONIMPLEMENTATION_HXX
#define OPENTURNS_EVENTSIMULATIONIMPLEMENTATION_HXX
...
class OT_API EventSimulationImplementation
...
public:
  ...
  explicit EventSimulationImplementation(const RandomVector & event,
                           const HistoryStrategy & convergenceStrategy = Compact());

  /** Virtual constructor */
  EventSimulationImplementation * clone() const override;
  ...
  EventSimulationImplementation(const HistoryStrategy & convergenceStrategy = Compact());
...
protected:
  ...
  friend class Factory<EventSimulationImplementation>;
...
#endif /* OPENTURNS_EVENTSIMULATIONIMPLEMENTATION_HXX */
