//                                               -*- C++ -*-
/**
 *  @brief CrossEntropyImportanceSamplingAlgorithm implement Importance Sampling by Cross Entropy algorithm
 *
 ...
 *
 */
#ifndef OPENTURNS_CROSSENTROPYIMPORTANCESAMPLINGALGORITHM_HXX
#define OPENTURNS_CROSSENTROPYIMPORTANCESAMPLINGALGORITHM_HXX
 ...
 *
 * CrossEntropyImportanceSamplingAlgorithm is some CrossEntropyImportanceSamplingAlgorithm type to illustrate how to add some classes in OpenTURNS
 */
class OT_API CrossEntropyImportanceSamplingAlgorithm
...
public:
  ...
  /** Default constructor */
  explicit  CrossEntropyImportanceSamplingAlgorithm(const RandomVector & event,
                 const Scalar rhoQuantile = ResourceMap::GetAsScalar("CrossEntropyImportanceSamplingAlgorithm-DefaultRhoQuantile"));

  /** Virtual constructor */
  virtual CrossEntropyImportanceSamplingAlgorithm * clone() const;
...
protected:
  ...
  // Result of CrossEntropyImportanceSamplingAlgorithm algorithm
...
#endif /* OPENTURNS_CROSSENTROPYIMPORTANCESAMPLINGALGORITHM_HXX */
