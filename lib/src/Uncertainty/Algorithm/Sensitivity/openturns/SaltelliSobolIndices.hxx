 ...
 *
 */
#ifndef OPENTURNS_SALTELLISOBOLINDICES_HXX
#define OPENTURNS_SALTELLISOBOLINDICES_HXX
...
/**
 * @class SaltelliSobolIndices
 *
 */

class OT_API SaltelliSobolIndices
...
public:
  ...
  /** Default constructor */
  SaltelliSobolIndices();

  /** Parameter constructor */
  SaltelliSobolIndices(const UnsignedInteger modelInputDimension,
                       const UnsignedInteger modelOutputDimension);

  /** Virtual constructor */
  virtual SaltelliSobolIndices * clone() const;
...
#endif /* OPENTURNS_SALTELLISOBOLINDICES_HXX */
