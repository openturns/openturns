  ...
  , functions_()
{
  ...
  setFunctionCollection(functions);
}
...
/* Functions accessor */
void FiniteOrthogonalFunctionFactory::setFunctionCollection(const FunctionCollection & functions)
{
...
FiniteOrthogonalFunctionFactory::FunctionCollection FiniteOrthogonalFunctionFactory::getFunctionCollection() const
{
  return functions_;
}
