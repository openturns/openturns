...
void ResourceMap::loadDefaultConfiguration()
{
  ...
  addAsScalar("GaussianProcessFitter-MaximalScaling", 1.0e-5);
  addAsScalar("GaussianProcessFitter-MeanEpsilon", 1.0e-12);
  addAsScalar("GaussianProcessFitter-StartingScaling", 1.0e-13);
  addAsString("GaussianProcessFitter-DefaultOptimizationAlgorithm", "TNC");
