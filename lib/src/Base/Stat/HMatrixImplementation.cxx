...
HMatrixImplementation::assemble(const HMatrixRealAssemblyFunction& f, char symmetry)
{
  ...
  static_cast<hmat_interface_t*>(hmatInterface_.get())->assemble_simple_interaction(static_cast<hmat_matrix_t*>(hmat_), const_cast<HMatrixRealAssemblyFunction*>(&f), &trampoline_simple, sym);
#else
...
void HMatrixImplementation::assemble(const HMatrixTensorRealAssemblyFunction& f, char symmetry)
{
  ...
  static_cast<hmat_interface_t*>(hmatInterface_.get())->assemble(
