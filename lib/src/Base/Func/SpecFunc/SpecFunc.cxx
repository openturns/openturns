...
Scalar SpecFunc::LogBesselInu(const Scalar x, const Scalar nu)
{
  ...
  auto asymptoticMu = [&](const UnsignedInteger kMax)
  {
    Scalar sum = 0.0;
    Scalar term = 1.0;
    const Scalar mu = 4.0 * nu * nu;
    ...
    const Scalar value = x - 0.5 * logX - LOGSQRT2PI + std::log(std::abs(1.0 + sum));
    return value;
  };

  // First case, use mu3
  if (((x > 1400.0) && (nu < 3.05)) || (((0.6229 * logX - 3.2318) > logNu) && (nu > 3.1)))
    return asymptoticMu(4);
  // Second case, use mu23 (extended from mu20 for higher accuracy)
  if (((x > 30.0) && (nu < 15.3919)) || (((0.5113 * logX + 0.7939) > logNu) && (x > 59.6925)))
    return asymptoticMu(23);
// These polynomials were generated by Maple in factorized form for improved numerical stability. They satisfy Uk(t) = u_k(t)/t^k where u_k are the polynomials in the reference
  auto U1 = [](const Scalar t)
  {
    return (-0.20833333333333333 * (t + 0.77459666924148338)) * (t - 0.77459666924148338);
  };
  auto U2 = [](const Scalar t)
  {
    return (0.33420138888888889 * (t + 0.99337556982854302)) * (t + 0.46174124492817127) * (t - 0.46174124492817127) * (t - 0.99337556982854302);
  };
  auto U3 = [](const Scalar t)
  {
    return (-1.0258125964506173 * (t + 1.0046555674733784)) * (t + 0.82935054325189063) * (t + 0.32069435160684980) * (t - 0.32069435160684980) * (t - 0.82935054325189063) * (t - 1.0046555674733784);
  };
  auto U4 = [](const Scalar t)
  {
    return (4.6695844234262474 * (t + 1.0004184103551594)) * (t + 0.94111090144693673) * (t + 0.67361861617014370) * (t + 0.24435882498737511) * (t - 0.24435882498737511) * (t - 0.67361861617014370) * (t - 0.94111090144693673) * (t - 1.0004184103551594);
  };
  auto U5 = [](const Scalar t)
  {
    return (-28.212072558200245 * (t + 0.99840764594992256)) * (t + 0.97810754452152945) * (t + 0.83338996230331075) * (t + 0.55958538121280712) * (t + 0.19701059799869142) * (t - 0.19701059799869142) * (t - 0.55958538121280712) * (t - 0.83338996230331075) * (t - 0.97810754452152945) * (t - 0.99840764594992256);
  };
  auto U6 = [](const Scalar t)
  {
    return (212.57013003921712 * (t + 0.99986938592120727)) * (t + 0.98937374278987914) * (t + 0.91039636333942206) * (t + 0.73395687736495199) * (t + 0.47612583127285472) * (t + 0.16489622420562242) * (t - 0.16489622420562242) * (t - 0.47612583127285472) * (t - 0.73395687736495199) * (t - 0.91039636333942206) * (t - 0.98937374278987914) * (t - 0.99986938592120727);
  };
  auto U7 = [](const Scalar t)
  {
    return (-1919.4576623184070 * (t + 1.0008917586639547)) * (t + 0.99385498265447565) * (t + 0.94932845745015188) * (t + 0.83378634780848332) * (t + 0.65047628471030761) * (t + 0.41332648777572373) * (t + 0.14172362014644258) * (t - 0.14172362014644258) * (t - 0.41332648777572373) * (t - 0.65047628471030761) * (t - 0.83378634780848332) * (t - 0.94932845745015188) * (t - 0.99385498265447565) * (t - 1.0008917586639547);
  };
  auto U8 = [](const Scalar t)
  {
    return (20204.291330966149 * (t + 1.0000913044350426)) * (t + 0.99753819916735608) * (t + 0.96989672317247450) * (t + 0.89301343798030280) * (t + 0.76143598290678447) * (t + 0.58167758797239267) * (t + 0.36468523249315409) * (t + 0.12423115047391226) * (t - 0.12423115047391226) * (t - 0.36468523249315409) * (t - 0.58167758797239267) * (t - 0.76143598290678447) * (t - 0.89301343798030280) * (t - 0.96989672317247450) * (t - 0.99753819916735608) * (t - 1.0000913044350426);
  };
  auto U9 = [](const Scalar t)
  {
    return (-2.4291918790055133e5 * (t + 0.98158259001585429)) * (t + 0.92929732156366408) * (t + 0.83376180762227885) * (t + 0.69690128200442930) * (t + 0.52483414989485500) * (t + 0.32603530516727116) * (t + 0.11056590276465110) * (t - 0.11056590276465110) * (t - 0.32603530516727116) * (t - 0.52483414989485500) * (t - 0.69690128200442930) * (t - 0.83376180762227885) * (t - 0.92929732156366408) * (t - 0.98158259001585429) * (t * t + 1.9990498972659430 * t + 0.99905162866056494) * (t * t - 1.9990498972659430 * t + 0.99905162866056494);
  };
  auto U10 = [](const Scalar t)
  {
    return (3.2844698530720378e6 * (t + 0.98880973571074488)) * (t + 0.95223842332159875) * (t + 0.88201458919188102) * (t + 0.77703225463168755) * (t + 0.64043461318217393) * (t + 0.47744202703933162) * (t + 0.29464953984769807) * (t + 0.99599483240041273e-1) * (t - 0.99599483240041273e-1) * (t - 0.29464953984769807) * (t - 0.47744202703933162) * (t - 0.64043461318217393) * (t - 0.77703225463168755) * (t - 0.88201458919188102) * (t - 0.95223842332159875) * (t - 0.98880973571074488) * (t * t + 1.9994612478927074 * t + 0.99946132086785818) * (t * t - 1.9994612478927074 * t + 0.99946132086785818);
  };
  auto U11 = [](const Scalar t)
  {
    return (-4.9329253664509962e7 * (t + 1.0007736305119772)) * (t + 0.99872408576220335) * (t + 0.99329761928069737) * (t + 0.96722220418388031) * (t + 0.91491675894150211) * (t + 0.83370670022785865) * (t + 0.72477625553853312) * (t + 0.59126209578866511) * (t + 0.43750296560645399) * (t + 0.26868944736756248) * (t + 0.90606290667180476e-1) * (t - 0.90606290667180476e-1) * (t - 0.26868944736756248) * (t - 0.43750296560645399) * (t - 0.59126209578866511) * (t - 0.72477625553853312) * (t - 0.83370670022785865) * (t - 0.91491675894150211) * (t - 0.96722220418388031) * (t - 0.99329761928069737) * (t - 0.99872408576220335) * (t - 1.0007736305119772);
  };
  auto U12 = [](const Scalar t)
  {
    return (8.1478909611831211e8 * (t + 1.0001395237390696)) * (t + 0.99971444452813620) * (t + 0.99562455289892799) * (t + 0.97727655370443013) * (t + 0.93781839662533590) * (t + 0.87444836165701956) * (t + 0.78707500187002931) * (t + 0.67744229906038361) * (t + 0.54838267815735331) * (t + 0.40348204881709327) * (t + 0.24687869435391206) * (t + 0.83098887935637689e-1) * (t - 0.83098887935637689e-1) * (t - 0.24687869435391206) * (t - 0.40348204881709327) * (t - 0.54838267815735331) * (t - 0.67744229906038361) * (t - 0.78707500187002931) * (t - 0.87444836165701956) * (t - 0.93781839662533590) * (t - 0.97727655370443013) * (t - 0.99562455289892799) * (t - 0.99971444452813620) * (t - 1.0001395237390696);
  };
  auto U13 = [](const Scalar t)
  {
    return (-1.4679261247695617e10 * (t + 0.99685899317493083)) * (t + 0.98410163838326928) * (t + 0.95406147056411588) * (t + 0.90418742233360804) * (t + 0.83366587749170256) * (t + 0.74328958239963429) * (t + 0.63485626061198897) * (t + 0.51083917920458419) * (t + 0.37420880072317122) * (t + 0.22830704344590139) * (t + 0.76737872420980019e-1) * (t - 0.76737872420980019e-1) * (t - 0.22830704344590139) * (t - 0.37420880072317122) * (t - 0.51083917920458419) * (t - 0.63485626061198897) * (t - 0.74328958239963429) * (t - 0.83366587749170256) * (t - 0.90418742233360804) * (t - 0.95406147056411588) * (t - 0.98410163838326928) * (t - 0.99685899317493083) * (t * t + 2.0002534348020824 * t + 1.0002541228185118) * (t * t - 2.0002534348020824 * t + 1.0002541228185118);
  };
  auto uPreamble = [&]()
  {
    const Scalar xp = x / nu;
    const Scalar invt = std::sqrt(1.0 + xp * xp);
  ...
  // Sixth case, use U13 (require x > 15 to avoid polynomial accuracy loss at small x)
  if (((x > 19.6931) && (nu > 0.7)) || ((nu > 12.6964) && (x > 15.0)))
  {
    auto [t, tOverNu, value] = uPreamble();
...
// Index of the maximum term in the summation
  const UnsignedInteger kMax = (std::sqrt(x * x + nu * nu) - nu) / 2;
  // The terms are increasing for k=0..K then decreasing (fast)
  // so we keep at most 2*K+1 terms
  Point logA(kMax + 1);
...
// Hypergeometric functions have been moved to HyperGeom.cxx
