...
double debyen(const double x, const int n)
{
  ...
  {
    double sum ;
    static const double nzetan[] = { 0., 1.64493406684822643647241516665e+00, 2.40411380631918857079947632302e+00,
  ...
  {
    static const double koeff[] = { 0., 1.289868133696452872944830333292e+00, 1.646464674222763830320073930823e-01,
