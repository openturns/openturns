...
{
  const UnsignedInteger dimension = getDimension();
  return static_cast<UnsignedInteger>(round(SpecFunc::Exp(SpecFunc::LnGamma(dimension + strataIndex) - SpecFunc::LnGamma(dimension) - SpecFunc::LnGamma(strataIndex + 1))));
}
...
{
  const UnsignedInteger dimension = getDimension();
  return static_cast<UnsignedInteger>(round(SpecFunc::Exp(SpecFunc::LnGamma(dimension + strataIndex + 1) - SpecFunc::LnGamma(dimension + 1) - SpecFunc::LnGamma(strataIndex + 1))));
}
