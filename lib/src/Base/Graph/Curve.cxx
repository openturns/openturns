...
Polygon Curve::FillBetween(Sample const& dataX, Sample const& dataY1, Sample const& dataY2) {
  ...
  if ((dataX.getDimension() != 1) || (dataY1.getDimension() != 1) || (dataY2.getDimension() != 1))
    throw InvalidArgumentException(HERE) << "Error: cannot fill between curves based on numerical samples of dimension greater than 1.";
