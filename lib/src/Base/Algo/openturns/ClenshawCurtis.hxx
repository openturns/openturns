 ...
 *
 */
#ifndef OPENTURNS_CLENSHAWCURTIS_HXX
#define OPENTURNS_CLENSHAWCURTIS_HXX
...
public:
  ...
  /** Default constructor */
  explicit ClenshawCurtis(const UnsignedInteger dimension = 1);

  /** Parameter constructor */
  explicit ClenshawCurtis(const Indices & discretization);

  /** Virtual copy constructor */
  virtual ClenshawCurtis * clone() const;
...
#endif /* OPENTURNS_CLENSHAWCURTIS_HXX */
