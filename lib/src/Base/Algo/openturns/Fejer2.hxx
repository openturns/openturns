 ...
 *
 */
#ifndef OPENTURNS_FEJER2_HXX
#define OPENTURNS_FEJER2_HXX
...
public:
  ...
  /** Default constructor */
  explicit Fejer2(const UnsignedInteger dimension = 1);

  /** Parameter constructor */
  explicit Fejer2(const Indices & discretization);

  /** Virtual copy constructor */
  virtual Fejer2 * clone() const;
