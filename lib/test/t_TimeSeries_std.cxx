...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    Point values3 = ts1.getValueAtIndex(tree.getNearestNeighbourIndex( Point(1, -1.0) ));
    fullprint << "values at t=-1.0 =" << values3 << std::endl;
    Point values4 = ts1.getValueAtIndex(tree.getNearestNeighbourIndex( Point(1, 1.45) ));
    fullprint << "values at t=1.45 =" << values4 << std::endl;
    Point values5 = ts1.getValueAtIndex(tree.getNearestNeighbourIndex( Point(1, 1.54) ));
    fullprint << "values at t=1.54 =" << values5 << std::endl;
    Point values6 = ts1.getValueAtIndex(tree.getNearestNeighbourIndex( Point(1, 14.5) ));
    fullprint << "values at t=14.5 =" << values6 << std::endl;

    // We set new values for the third element of the ts
    ts1.setValueAtIndex(tree.getNearestNeighbourIndex( Point(1, 1.54) ), values6 * -1.0 );
    fullprint << "ts1=" << ts1 << std::endl;
