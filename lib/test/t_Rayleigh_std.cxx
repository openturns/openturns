...
int main(int, char *[])
{
  ...
  try
  {
    ...
    assert_almost_equal(interval.getLowerBound(), {-0.2238}, 1e-3, 0.0);
    assert_almost_equal(interval.getUpperBound(), {5.7505}, 1e-3, 0.0);
    ...
    Rayleigh::PointWithDescriptionCollection parameters = distribution.getParametersCollection();
