//                                               -*- C++ -*-
/**
 *  @brief The test file of class InverseChiSquare for standard methods
 *
...
class TestObject : public InverseChiSquare
{
public:
  TestObject() : InverseChiSquare(1.5) {}
  virtual ~TestObject() {}
};
...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    Collection<InverseChiSquare> allDistributions(0);
    allDistributions.add(InverseChiSquare(10.5));
    allDistributions.add(InverseChiSquare(15.0));
    for (UnsignedInteger n = 0; n < allDistributions.getSize(); ++n)
    {
      InverseChiSquare distribution(allDistributions[n]);
      ...
      // Define a point
      NumericalPoint point( distribution.getDimension(), 2.0 / distribution.getNu() );
    ...
    fullprint << "Survival(inverse survival)=" << distribution.computeSurvivalFunction(InverseSurvival) << std::endl;
      ...
      InverseChiSquare::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
