...
int main(int, char *[])
{
  ...
  try
  {
    ...
    for (UnsignedInteger n = 0; n < allDistributions.getSize(); ++n)
    {
      ...
      // Define a point
      Point point( distribution.getDimension(), 2.0 / distribution.getNu() );
      ...
      InverseChiSquare::PointWithDescriptionCollection parameters = distribution.getParametersCollection();
