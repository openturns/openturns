...
//     fullprint << "cdf gradient (FD)=" << CDFgrFD << std::endl;
    ...
    Sample sample(distribution.getSample(1000000));
    fullprint << "entropy (MC)=" << -distribution.computeLogPDF(sample).computeMean()[0] << std::endl;
    Point mean = distribution.getMean();
    fullprint << "mean=" << mean << std::endl;
    fullprint << "mean (MC)=" << sample.computeMean()[0] << std::endl;
    Point standardDeviation = distribution.getStandardDeviation();
    fullprint << "standard deviation=" << standardDeviation << std::endl;
    fullprint << "standard deviation (MC)=" << sample.computeStandardDeviation()[0] << std::endl;
    Point skewness = distribution.getSkewness();
    fullprint << "skewness=" << skewness << std::endl;
    fullprint << "skewness (MC)=" << sample.computeSkewness()[0] << std::endl;
    Point kurtosis = distribution.getKurtosis();
    fullprint << "kurtosis=" << kurtosis << std::endl;
    fullprint << "kurtosis (MC)=" << sample.computeKurtosis()[0] << std::endl;
    CovarianceMatrix covariance = distribution.getCovariance();
    fullprint << "covariance=" << covariance << std::endl;
    fullprint << "covariance (MC)=" << sample.computeCovariance() << std::endl;
