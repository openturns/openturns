//                                               -*- C++ -*-
/**
 *  @brief The test file of class MultivariateHypergeometric for standard methods
 *
...
int main(int, char *[])
{
  ...
  try
  {
    ...
    MultivariateHypergeometric::PointWithDescriptionCollection parameters = distribution.getParametersCollection();
