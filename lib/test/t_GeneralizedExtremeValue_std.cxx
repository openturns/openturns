//                                               -*- C++ -*-
/**
 *  @brief The test file of class GeneralizedExtremeValue for standard methods
 *
...
class TestObject : public GeneralizedExtremeValue
{
public:
  TestObject() : GeneralizedExtremeValue(2.0, 1.5, -0.5) {}
  virtual ~TestObject() {}
};
...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    for (UnsignedInteger i = 0; i < all_cases.getSize(); ++i)
    {
      ...
      GeneralizedExtremeValue::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
      ...
      fullprint << "xi=" << distribution.getXi() << std::endl;
      fullprint << "Actual distribution=" << distribution.getActualDistribution() << std::endl;
    }
  }
  catch (TestFailed & ex)
  {
