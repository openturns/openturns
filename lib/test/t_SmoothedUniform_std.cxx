//                                               -*- C++ -*-
/**
 *  @brief The test file of class SmoothedUniform for standard methods
 *
...
class TestObject : public SmoothedUniform
{
public:
  TestObject() : SmoothedUniform(-0.5, 1.5, 0.5) {}
  virtual ~TestObject() {}
};
...
int main(int, char *[])
{
  ...
  try
  {
    ...
    SmoothedUniform distribution(-0.5, 1.5, 0.5);
    ...
    Point PDFgrFD(3);
    PDFgrFD[0] = (SmoothedUniform(distribution.getA() + eps, distribution.getB(), distribution.getSigma()).computePDF(point) -
                  SmoothedUniform(distribution.getA() - eps, distribution.getB(), distribution.getSigma()).computePDF(point)) / (2.0 * eps);
    PDFgrFD[1] = (SmoothedUniform(distribution.getA(), distribution.getB() + eps, distribution.getSigma()).computePDF(point) -
                  SmoothedUniform(distribution.getA(), distribution.getB() - eps, distribution.getSigma()).computePDF(point)) / (2.0 * eps);
    PDFgrFD[2] = (SmoothedUniform(distribution.getA(), distribution.getB(), distribution.getSigma() + eps).computePDF(point) -
                  SmoothedUniform(distribution.getA(), distribution.getB(), distribution.getSigma() - eps).computePDF(point)) / (2.0 * eps);
    ...
    Point CDFgrFD(3);
    CDFgrFD[0] = (SmoothedUniform(distribution.getA() + eps, distribution.getB(), distribution.getSigma()).computeCDF(point) -
                  SmoothedUniform(distribution.getA() - eps, distribution.getB(), distribution.getSigma()).computeCDF(point)) / (2.0 * eps);
    CDFgrFD[1] = (SmoothedUniform(distribution.getA(), distribution.getB() + eps, distribution.getSigma()).computeCDF(point) -
                  SmoothedUniform(distribution.getA(), distribution.getB() - eps, distribution.getSigma()).computeCDF(point)) / (2.0 * eps);
    CDFgrFD[2] = (SmoothedUniform(distribution.getA(), distribution.getB(), distribution.getSigma() + eps).computeCDF(point) -
                  SmoothedUniform(distribution.getA(), distribution.getB(), distribution.getSigma() - eps).computeCDF(point)) / (2.0 * eps);
    ...
    SmoothedUniform::PointWithDescriptionCollection parameters = distribution.getParametersCollection();
