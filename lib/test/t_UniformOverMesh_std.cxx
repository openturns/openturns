//                                               -*- C++ -*-
/**
 *  @brief The test file of class UniformOverMesh for standard methods
 *
...
int main(int, char *[])
{
  ...
  try
  {
    ...
    Point lower = {-0.75, -0.5};
    Point upper = { 0.75,  0.5};
    Mesh mesh(mesher.build(domain, Interval(lower, upper), false));
    UniformOverMesh distribution(mesh);
    ...
    */
    ...
    UniformOverMesh::PointWithDescriptionCollection parameters = distribution.getParametersCollection();
