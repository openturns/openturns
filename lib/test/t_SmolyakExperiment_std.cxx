...
void test_4()
{
  ...
  ResourceMap::SetAsScalar( "SmolyakExperiment-MergeRelativeEpsilon", 1.e-2);
  ResourceMap::SetAsScalar( "SmolyakExperiment-MergeAbsoluteEpsilon", 1.e-2);
  //
  Point x1({0.1, 0.2});
  Point y1({0.3, 0.4});
  //
...
void test_7()
{
  ...
  ResourceMap::SetAsScalar("SmolyakExperiment-MergeAbsoluteEpsilon", 0.0);
  Point weightsTer(0);
