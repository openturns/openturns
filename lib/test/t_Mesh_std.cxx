...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    }
    {
      ...
      {
        Point point(1, 1.8);
        UnsignedInteger nearestIndex = tree.getNearestNeighbourIndex(point);
      ...
      fullprint << "Nearest index(" << points << ")=" << tree.getNearestNeighbourIndex(points) << std::endl;
    ...
    }
    {
      ...
      Point point(2, 1.8);
      fullprint << "Nearest index(" << point << ")=" << tree.getNearestNeighbourIndex(point) << std::endl;
      Sample points(2, 2);
