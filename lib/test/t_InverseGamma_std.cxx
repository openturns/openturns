//                                               -*- C++ -*-
/**
 *  @brief The test file of class InverseGamma for standard methods
 *
...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    for (UnsignedInteger n = 0; n < allDistributions.getSize(); ++n)
    {
      ...
      // Define a point
      NumericalPoint point( distribution.getDimension(), 2.0 / (distribution.getK() * distribution.getLambda()) );
      ...
      InverseGamma::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
