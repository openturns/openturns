...
int main(int, char *[])
{
  ...
  ResourceMap::SetAsUnsignedInteger("OptimizationAlgorithm-DefaultMaximumCallsNumber", 2000);
  ...
  try
  {
    ...
    // Test 3 : R --> R^2 function
    {
      ...
      const Point rowData = {4.4655975, 0.0, 8.3485681, 0.0, 0.0, 2.9309595, 0.0, 5.4795163, \
                             8.3485681, 0.0, 15.756016, 0.0, 0.0, 5.4795163, 0.0, 10.341336
                            };
