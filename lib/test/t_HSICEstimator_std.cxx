//                                               -*- C++ -*-
/**
 *  @brief The test file of class HSICEstimator
 *
...
int main(int, char *[])
{
  ...
  try
  {
    ...
    */
    ...
    HSICEstimator hsic(covarianceList, X, Y, estimatorType, weight);
    ...
    Point referenceHSICIndices = {0.000640331, 0.000257692, 0.0110516};
    ...
    Point referencePValues = {0.777223, 0.954046, 0.000999001};
