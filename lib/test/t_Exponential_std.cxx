...
{
public:
  TestObject() : Exponential(2.5, -0.5) {}
  virtual ~TestObject() {}
};
...
int main(int, char *[])
{
  ...
  try
  {
    ...
    // The comparison is not very convincing with the current state of the random generator...
    ...
    Exponential::PointWithDescriptionCollection parameters = distribution.getParametersCollection();
