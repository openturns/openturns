//                                               -*- C++ -*-
/**
 *  @brief The test file of class MaximumEntropyOrderStatisticsDistribution for standard methods
 *
...
class TestObject : public MaximumEntropyOrderStatisticsDistribution
{
public:
  TestObject() : MaximumEntropyOrderStatisticsDistribution() {}
  virtual ~TestObject() {}
};
...
//     point[0]=1.; point[1] = 3.31; point[2] = 5.;
...
//     fullprint << "survival=" << Survival << std::endl;
    ...
    MaximumEntropyOrderStatisticsDistribution::PointWithDescriptionCollection parameters = distribution.getParametersCollection();
