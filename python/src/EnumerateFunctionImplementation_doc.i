...
See Also
--------
LinearEnumerateFunction, HyperbolicAnisotropicEnumerateFunction, NormInfEnumerateFunction)RAW"
%enddef
...
R"RAW(Return the dimension of the *EnumerateFunction*.

Returns
-------
dim : int, :math:`dim \geq 0`
    Dimension of the *EnumerateFunction*.)RAW"
%enddef
...
R"RAW(Get the number of multi-indices of total degree lower or equal to a threshold.
...
R"RAW(Get the largest index of the strata containing multi-indices lower or equal to the given maximum degree.
...
R"RAW(Set the dimension of the *EnumerateFunction*.
...
R"RAW(Get the basis size corresponding to a total degree.
...
R"RAW(Get the marginal enumerate function.
...
enumerateFunction : :class:`~openturns.EnumerateFunction`
    The marginal enumerate function.)RAW"
%enddef
