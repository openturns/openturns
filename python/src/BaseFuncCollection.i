...
namespace OT {
  ...
  canConvert< _PyObject_, OT::Function >(PyObject * pyObj)
  {
    ...
    if (SWIG_IsOK(SWIG_ConvertPtr(pyObj, &ptr, SWIG_TypeQuery("OT::Function *"), SWIG_POINTER_NO_NULL))) {
      ...
      return p_nmf != NULL;
    } else if (SWIG_IsOK(SWIG_ConvertPtr( pyObj, &ptr, SWIG_TypeQuery("OT::FunctionImplementation *"), SWIG_POINTER_NO_NULL))) {
      OT::FunctionImplementation * p_impl = reinterpret_cast< OT::FunctionImplementation * >(ptr);
      return p_impl != NULL;
    } else {
      // pure callable
      return PyCallable_Check(pyObj) && !SWIG_IsOK(SWIG_ConvertPtr(pyObj, &ptr, SWIG_TypeQuery("OT::Object *"), SWIG_POINTER_NO_NULL));
    }
    return false;
  }
  ...
  convert< _PyObject_, OT::Function >(PyObject * pyObj)
  {
    ...
    if (SWIG_IsOK(SWIG_ConvertPtr(pyObj, &ptr, SWIG_TypeQuery("OT::Function *"), 0))) {
      ...
      OT::FunctionImplementation * p_impl = reinterpret_cast< OT::FunctionImplementation * >(ptr);
      return *p_impl;
    } else if (!PyCallable_Check(pyObj) || SWIG_IsOK(SWIG_ConvertPtr(pyObj, &ptr, SWIG_TypeQuery("OT::Object *"), SWIG_POINTER_NO_NULL))) {
  ...
  {
    void * ptr = 0;
    if (SWIG_IsOK(SWIG_ConvertPtr(pyObj, &ptr, SWIG_TypeQuery("OT::Basis *"), SWIG_POINTER_NO_NULL))) {
      OT::Basis * p_nmf = reinterpret_cast< OT::Basis * >(ptr);
      return p_nmf != NULL;
    } else if (SWIG_IsOK(SWIG_ConvertPtr(pyObj, &ptr, SWIG_TypeQuery("OT::BasisImplementation *"), SWIG_POINTER_NO_NULL))) {
