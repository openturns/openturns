...
%typemap(in) const Domain & {
  ...
  } else if (SWIG_IsOK(SWIG_ConvertPtr($input, &ptr, SWIG_TypeQuery("OT::Pointer<OT::DomainImplementation> *"), 0))) {
    // From Pointer<DomainImplementation>
    OT::Pointer<OT::DomainImplementation> * p_impl = reinterpret_cast< OT::Pointer<OT::DomainImplementation> * >(ptr);
    $1 = new OT::Domain(**p_impl);
...
%typemap(typecheck,precedence=SWIG_TYPECHECK_POINTER) const Domain & {
  $1 = SWIG_IsOK(SWIG_ConvertPtr($input, NULL, $1_descriptor, 0))
    ...
    || SWIG_IsOK(SWIG_ConvertPtr($input, NULL, SWIG_TypeQuery("OT::Pointer<OT::DomainImplementation> *"), 0))
