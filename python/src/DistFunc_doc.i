...
R"RAW(Logarithm of the probability distribution function of a binomial distribution.
...
R"RAW(probability distribution function of a binomial distribution.
...
R"RAW(Realization of a binomial distribution.
...
R"RAW(Realization of a bounded integral discrete distribution.
...
R"RAW(Logarithm of the probability distribution function of an hypergeometric distribution.
...
R"RAW(The probability distribution function of an hypergeometric distribution.
...
R"RAW(Cumulative distribution function of an hypergeometric distribution.
...
R"RAW(Realization of an hypergeometric distribution.
...
R"RAW(Cumulative distribution function of a 3D Normal distribution.
...
R"RAW(Exact margin factor for bilateral covering interval of pooled Normal samples.
...
R"RAW(Exact margin factor for bilateral covering interval of a Normal sample.
...
R"RAW(Cumulative distribution function  of the Pearson statistic distribution.
...
R"RAW(Logarithm of the probability distribution function of a Poisson distribution.
...
R"RAW(probability distribution function of a Poisson distribution.
...
R"RAW(Realization of a Poisson distribution.
...
R"RAW(Quantile of a Poisson distribution.
...
R"RAW(Probability density function of a NonCentralChiSquare distribution.
...
R"RAW(Realization of a NonCentralChiSquare distribution.
...
R"RAW(Cumulative distribution function  of a NonCentralChiSquare.
...
R"RAW(Probability density function of a NonCentralStudent distribution.
...
R"RAW(Realization of a scalar NonCentralStudent distribution.
...
R"RAW(Cumulative distribution function  of a NonCentralStudent distribution.
...
R"RAW(Quantile of a scalar Student distribution.
...
R"RAW(Cumulative distribution function  of a scalar Student distribution.
...
R"RAW(Cumulative distribution function of a 2-d Student distribution.
...
R"RAW(Realization of a scalar Student distribution.
...
R"RAW(Realization of a uniform distribution over a segment.
...
R"RAW(Realization of a uniform distribution over a triangle.
...
R"RAW(Realization of a uniform distribution over a tetrahedron.
...
R"RAW(Realization of a uniform distribution over a simplex.
...
R"RAW(Cumulative distribution function  of a Beta distribution on :math:`[0,1]`.
...
R"RAW(Quantile of a Beta distribution on :math:`[0,1]`.
...
R"RAW(Realization of a Beta distribution on :math:`[0,1]`.
...
R"RAW(Cumulative distribution function  of a Gamma distribution on :math:`[0,+\infty[`.
...
R"RAW(Quantile of a Gamma distribution on :math:`[0,+\infty[`.
...
R"RAW(Realization of a Gamma distribution on :math:`[0,+\infty[`.
...
R"RAW(Cumulative distribution function  of a Kolmogorov distribution.
...
R"RAW(Quantile of the Dickey-Fuller statistic.
...
R"RAW(Cumulative distribution function of the Dickey-Fuller statistic.
