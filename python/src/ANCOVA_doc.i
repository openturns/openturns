...
[0.123494,0.123494])RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::ANCOVA::getUncorrelatedIndices
R"RAW(Accessor to the ANCOVA indices measuring uncorrelated effects.
...
indices : :class:`~openturns.Point`
    ...
    :meth:`getUncorrelatedIndices` lists.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::ANCOVA::getIndices
R"RAW(Accessor to the ANCOVA indices.
