...
Refer to :ref:`least_squares` to get details on general least squares meta models
...
Notes
-----
To get the meta model :math:`\metaModel` defined in :eq:`LinearLeastSquaresMMOpenTURNSAPI`
