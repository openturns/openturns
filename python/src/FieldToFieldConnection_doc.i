...
R"RAW(Composition function :math:`f \circ g` where :math:`g` acts on fields and :math:`f` produces fields.
...
Notes
-----
This class is a particular case  of the general class :class:`~openturns.FieldFunction`. Thus it doesn't implement the  gradient nor the hessian.)RAW"
