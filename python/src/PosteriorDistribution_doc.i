...
- ``PosteriorDistribution-OptimizationAlgorithm`` (``String``, default: ``Cobyla``): name of the optimization algorithm used to compute the maximum of the log-posterior density of the ratio-of-uniforms sampler
