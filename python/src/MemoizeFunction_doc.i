...
its input and output history are copied into the current instance.
...
By default, the cache mechanism and the history mechanism ar enabled.
...
marginal : :class:`~openturns.Function`
    ...
    class which had been used for this function.)RAW"
