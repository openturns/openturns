...
R"RAW(Compute the mean field of the collection of fields.
...
R"RAW(Compute the spatial mean of the values of the fields.
...
R"RAW(Compute the temporal mean of the values of the fields.
...
R"RAW(Compute the standard deviation field of the collection of fields.
...
stddev : :class:`~openturns.Field`
    ...
    .. math::
        ...
        \forall i \in [0,N-1], \quad \sqrt{\dfrac{1}{K-1} \sum_{k=1}^K (\vect{x}_i^k - \hat{\mu}_i)^2})RAW"
%enddef
...
R"RAW(Compute the quantile field of the collection of fields.
