...
R"RAW(Particular classifier based on a mixture distribution.
...
See useful methods :meth:`classify` and :meth:`grade`.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::MixtureClassifier::classify
R"RAW(Classify points according to the classifier.
...
class of each point of *inputSample*.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::MixtureClassifier::grade
R"RAW(Grade points according to the classifier.
...
:math:`i^{th}` class of *classList*.)RAW"
