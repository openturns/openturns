...
R"RAW(Accessor to the shape parameter.
...
R"RAW(Accessor to the scale parameter.
...
R"RAW(Accessor to the location parameter.

Parameters
----------
gamma : float, :math:`\gamma > 0`
    Location parameter.)RAW"
