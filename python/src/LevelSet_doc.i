...
R"RAW(Return the intersection with another LevelSet.
...
R"RAW(Return the union with another LevelSet.
...
R"RAW(Get the function defining the level set.
...
R"RAW(Set the function defining the level set.
