...
R"RAW(NormalGamma distribution.
...
R"RAW(Accessor to the parameter alpha.

Returns
-------
alpha : float, :math:`\alpha`, :math:`\alpha >0`
        Shape parameter of the conditioning Gamma distribution of :math:`Y`)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::NormalGamma::getBeta
R"RAW(Accessor to the parameter beta.

Returns
-------
beta : float, :math:`\beta`, :math:`\beta >0`
       Rate parameter of the conditioning Gamma distribution of :math:`Y`)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::NormalGamma::getKappa
R"RAW(Accessor to the parameter kappa.

Returns
-------
kappa : float, :math:`\kappa`, :math:`\kappa >0`
        Scale parameter of the precision (ie the inverse of the variance) of the conditioned Normal distribution of :math:`X|Y`)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::NormalGamma::getMu
R"RAW(Accessor to the parameter mu.

Returns
-------
mu : float, :math:`\mu`,
     Mean of the conditioned Normal distribution of :math:`X|Y`)RAW"
