...
"L2 approximation on an orthonormal basis using least-squares and orthogonal matching pursuit model selection.
...
>>> basisSize = 5
>>> algo = ot.OMPExpansion(inSample, outSample, distribution, basis, basisSize, 'QR')
>>> algo.run()"
