...
R"RAW(Get the Joe copula parameter :math:`\theta`.
...
R"RAW(Set the Joe copula parameter :math:`\theta`.
...
R"RAW(Get the Joe copula parameter :math:`\psi_1`.
...
R"RAW(Set the Joe copula parameter :math:`\psi_1`.
...
R"RAW(Get the Joe copula parameter :math:`\psi_2`.
...
R"RAW(Set the Joe copula parameter :math:`\psi_2`.
