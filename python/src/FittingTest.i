...
%typemap(argout) OT::TestResult & bestResultOut %{ $result = OT::AppendOutput($result, SWIG_NewPointerObj(new OT::TestResult(*$1), SWIGTYPE_p_OT__TestResult,  SWIG_POINTER_OWN)); %}
...
%typemap(argout) OT::Distribution & estimatedDistribution %{ $result = OT::AppendOutput( SWIG_NewPointerObj(new OT::Distribution(*$1), SWIGTYPE_p_OT__Distribution,  SWIG_POINTER_OWN), $result)  ; %}
