...
R"RAW(Sensitivity analysis based on functional chaos expansion.
...
Print Sobol' indices (see :doc:`/auto_surrogate_modeling/polynomial_chaos/plot_chaos_ishigami_grouped_indices`
for details):
...
R"RAW(Get the first order Sobol' index of an input variable
...
s : float
    ...
    of a group of input variables.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::FunctionalChaosSobolIndices::getSobolTotalIndex
R"RAW(Get the Sobol' total index of an input variable or the total interaction
...
s : float
    ...
    index of a group of input variables.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::FunctionalChaosSobolIndices::getSobolGroupedIndex
R"RAW(Get the Sobol' first order closed index of a group of input variables.
...
-------
s : float
    The Sobol' first order closed index of a group of input variables.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::FunctionalChaosSobolIndices::getSobolGroupedTotalIndex
R"RAW(Get the Sobol' total index of a group of input variables.
...
-------
s : float
    The Sobol' total closed index of a group of input variables.)RAW"
