...
R"RAW(Accessor to the first order indices.
...
indices : :class:`~openturns.Point`
    List of the first order indices of all the inputs.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::FAST::getTotalOrderIndices
R"RAW(Accessor to the total order indices.
...
-------
indices : :class:`~openturns.Point`
    List of the total-effect order indices of all the inputs.)RAW"
