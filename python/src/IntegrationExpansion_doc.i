...
:any:`functional_chaos` by equation :eq:`metaModelPn` whith no model selection: the model
...
of *distribution*: it implies that this *basis* are orthogonal to the input distribution only in
