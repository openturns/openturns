...
R"RAW(Accessor to the distribution's lower bound in log-scale :math:`a_\ell`.

Returns
-------
a_log : float
    Lower bound in log-scale.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::LogUniform::getBLog
R"RAW(Accessor to the distribution's upper bound in log-scale :math:`b_\ell`.

Returns
-------
b_log : float
    Upper bound in log-scale.)RAW"
