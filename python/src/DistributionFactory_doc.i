...
%feature("docstring") OT::DistributionFactory::getKnownParameterIndices
...
%feature("docstring") OT::DistributionFactory::GetByName
...
- *DistributionFactory-BootstrapErrorTolerance* (``Scalar``, default: `0.1`)"
