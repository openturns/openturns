...
R"RAW(Evaluation of the composition :math:`f \circ g` where :math:`g` acts on points and :math:`f` produces points.
...
- *PointToPointEvaluation-BlockSize* (:raw:`UnsignedInteger`, default: `256`)
)RAW"
