...
convergenceStrategy : :class:`~openturns.HistoryStrategy`, optional
    ...
    By default, the :class:`~openturns.Full` strategy is used.
...
The convergence graph of the probability estimator is plotted from the stored history of the values (estimator values and its variance)
according to the given strategy. To get the sample of values (estimator, variance), use the method :meth:`~openturns.ProbabilitySimulationAlgorithm.getConvergenceStrategy` and
then the method :meth:`~openturns.HistoryStrategy.getSample()`.
...
%feature("docstring") OT::ProbabilitySimulationAlgorithm::setKeepSample
...
%feature("docstring") OT::ProbabilitySimulationAlgorithm::getInputSample
...
%feature("docstring") OT::ProbabilitySimulationAlgorithm::getOutputSample
