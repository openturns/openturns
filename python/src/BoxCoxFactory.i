...
%typemap(argout) OT::LinearModelResult & linearModelResultOut %{ $result = OT_AppendOutput($result, SWIG_NewPointerObj(new OT::LinearModelResult(*$1), SWIGTYPE_p_OT__LinearModelResult,  SWIG_POINTER_OWN)); %}
