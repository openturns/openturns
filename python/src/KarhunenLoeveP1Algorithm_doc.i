...
R"RAW(Computation of Karhunen-Loeve decomposition using P1 approximation.
...
R"RAW(Accessor to the mesh.

Returns
-------
mesh : :class:`~openturns.Mesh`
    The mesh :math:`\cD_N` that discretizes the domain :math:`\cD`.)RAW"
