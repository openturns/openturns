...
Notes
-----
The response surface is the first-order Taylor expansion of the function :math:`h` at the point :math:`\ux_0`. Refer to :any:`Taylor Expansion <taylor_expansion>` for details.
