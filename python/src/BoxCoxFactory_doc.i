...
R"RAW(BoxCox transformation estimator.
...
- *BoxCoxFactory-DefaultMaximumCallsNumber* (``UnsignedInteger``, default: `2000`)
- *BoxCoxFactory-DefaultPointNumber* (``UnsignedInteger``, default: `201`)
- *BoxCoxFactory-DefaultRhoBeg* (``Scalar``, default: `0.1`)

- *BoxCoxFactory-DefaultRhoEnd* (``Scalar``, default: `1e-10`)
...
R"RAW(Estimate the Box Cox transformation with graph output.
...
graph : :class:`~openturns.Graph`
    ...
    It enables to graphically detect the optimal values.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::BoxCoxFactory::buildWithLM
R"RAW(Estimate the Box Cox transformation with linear model.
...
R"RAW(Estimate the Box Cox transformation.
