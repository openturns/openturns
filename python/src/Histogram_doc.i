...
R"RAW(Accessor to the width.

Returns
-------
width : :class:`~openturns.Point`
    The collection of :math:`\ell_i`, the width of class `i`.)RAW"
// ---------------------------------------------------------------------
...
R"RAW(Accessor to the widths and heights.
...
height : :class:`~openturns.Point`
    The collection of :math:`h_i`, the height of class `i`.)RAW"
