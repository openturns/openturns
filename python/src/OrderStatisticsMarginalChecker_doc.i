...
- ``OrderStatisticsMarginalChecker-OptimizationEpsilon`` (``Scalar``, default: ``1e-07``): tolerance :math:`\epsilon` used in tests 2 and 3.
- ``OrderStatisticsMarginalChecker-QuantileIteration`` (``UnsignedInteger``, default: ``100``): number :math:`n` of quantiles used in test 2.
