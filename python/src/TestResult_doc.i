...
R"RAW(Accessor to the test's p-value.

Returns
-------
p_value : float, :math:`0 \leq p \leq 1`
    The test's p-value.)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::TestResult::getThreshold
R"RAW(Accessor to the accepted risk of committing a Type I error.

Returns
-------
threshold : float, :math:`0 \leq \alpha \leq 1`
    Accepted risk of committing a Type I error.)RAW"
