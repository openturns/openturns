...
R"RAW(Test for unit root in model with drift and trend.
...
R"RAW(Test for unit root in model with drift.
...
R"RAW(Test for unit root in AR1 model.
...
R"RAW(Test for linear trend in model with unit root.
...
R"RAW(Test for trend in model without unit root.
...
R"RAW(Test for null drift in model with unit root.
...
R"RAW(Test for null drift in model without unit root.
...
R"RAW(Test the stationarity without any assumption on the model.
