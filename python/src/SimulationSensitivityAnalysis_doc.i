...
R"RAW(Compute the importance factors.
...
- *SimulationSensitivityAnalysis-DefaultSampleMargin* (:raw:`UnsignedInteger`, default: `400`)
)RAW"

// ---------------------------------------------------------------------

%feature("docstring") OT::SimulationSensitivityAnalysis::computeMeanPointInEventDomain
R"RAW(Accessor to the mean point.
...
the realizations :math:`\vect{X}_i`.)RAW"
...
R"RAW(Draw the importance factors evolution.
...
R"RAW(Compute the sensitivity to the probability.
...
sensitivity_pf : :class:`~openturns.PointWithDescription`
    The probability sensitivity.)RAW"
