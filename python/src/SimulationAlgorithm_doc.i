...
%define OT_SimulationAlgorithm_getBlockSize_doc
...
%define OT_SimulationAlgorithm_setBlockSize_doc
...
- ``SimulationAlgorithm-DefaultBlockSize`` (``UnsignedInteger``, default: ``1``): default block size of the simulation algorithms

- ``SimulationAlgorithm-DefaultMaximumTimeDuration`` (``Scalar``, default: ``-1.0``): default maximum duration, in seconds, of the simulation algorithms
...
%define OT_SimulationAlgorithm_getMaximumCoefficientOfVariation_doc
...
%define OT_SimulationAlgorithm_setMaximumCoefficientOfVariation_doc
"Accessor to the maximum coefficient of variation.
...
%define OT_SimulationAlgorithm_getMaximumOuterSampling_doc
...
%define OT_SimulationAlgorithm_setMaximumOuterSampling_doc
"Accessor to the maximum iterations number.
...
%define OT_SimulationAlgorithm_getMaximumStandardDeviation_doc
...
%define OT_SimulationAlgorithm_setMaximumStandardDeviation_doc
R"RAW(Accessor to the maximum standard deviation.
...
%define OT_SimulationAlgorithm_setProgressCallback_doc
...
%define OT_SimulationAlgorithm_setStopCallback_doc
...
%define OT_SimulationAlgorithm_getConvergenceStrategy_doc
...
%define OT_SimulationAlgorithm_setConvergenceStrategy_doc
"Accessor to the convergence strategy.
...
%define OT_SimulationAlgorithm_setMaximumTimeDuration_doc
...
%define OT_SimulationAlgorithm_getMaximumTimeDuration_doc
"Accessor to the maximum duration.
