...
R"RAW(Accessor to the solver used to optimize the covariance model parameters.
...
R"RAW(Accessor to the reduced log-likelihood function that writes as argument of the covariance's model parameters.
