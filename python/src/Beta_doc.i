...
R"RAW(Accessor to the distribution's shape parameter :math:`\beta`.

Returns
-------
beta : float
    Shape parameter :math:`\beta`.)RAW"
...
R"RAW(Test whether the distribution is elliptical.
