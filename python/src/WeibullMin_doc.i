...
R"RAW(Accessor to the distribution shape parameter :math:`\alpha`.
...
R"RAW(Accessor to the distribution scale parameter :math:`\beta`.
...
R"RAW(Accessor to the distribution location parameter :math:`\gamma`.
