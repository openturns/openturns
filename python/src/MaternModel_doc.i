...
- ``MaternModel-DefaultNu`` (``Scalar``, default: ``1.5``): default value of the regularity parameter :math:`\nu`.
- ``MaternModel-DefaultTheta`` (``Scalar``, default: ``1``): default value of the scale parameter :math:`\vect{\theta}`.
