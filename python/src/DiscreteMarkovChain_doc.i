...
- ``DiscreteMarkovChain-ProbabilitySumPrecision`` (``Scalar``, default: ``1e-06``): admitted error on the sum
  of each line of the transition matrix, which must be equal to 1,
- ``DiscreteMarkovChain-DOTArcColor`` (``String``, default: ``black``): color of the arcs of the DOT graph
  generated by :meth:`exportToDOTFile`,
- ``DiscreteMarkovChain-DOTLayout`` (``String``, default: ``dot``): layout algorithm of the DOT graph
  generated by :meth:`exportToDOTFile`,
- ``DiscreteMarkovChain-DOTNodeColor`` (``String``, default: ``black``): color of the nodes of the DOT graph
  generated by :meth:`exportToDOTFile`,
- ``DiscreteMarkovChain-DOTNodeShape`` (``String``, default: ``oval``): shape of the nodes of the DOT graph
  generated by :meth:`exportToDOTFile`
...
- ``DiscreteMarkovChain-DOTArcColor`` (``String``, default: ``black``): the color of the arcs of the graph,
- ``DiscreteMarkovChain-DOTLayout`` (``String``, default: ``dot``): the layout engine of the graph,
- ``DiscreteMarkovChain-DOTNodeColor`` (``String``, default: ``black``): the color of the nodes of the graph,
- ``DiscreteMarkovChain-DOTNodeShape`` (``String``, default: ``oval``): the shape of the nodes of the graph."
