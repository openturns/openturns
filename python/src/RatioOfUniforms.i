...
%typemap(argout) OT::UnsignedInteger & tryNumberOut %{ $result = OT::AppendOutput($result, OT::convert<OT::UnsignedInteger, OT::_PyLong_>(*$1)); %}
...
%template(_MultiStartCollection) OT::Collection<OT::MultiStart>;
