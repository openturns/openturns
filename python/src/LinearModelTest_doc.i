...
R"RAW(Test the nullity of the linear regression model coefficients.
...
R"RAW(Test zero mean value of the residual of the linear regression model.
...
R"RAW(Test the homoskedasticity of the linear regression model residuals.
...
R"RAW(Test the autocorrelation of the linear regression model residuals.
...
R"RAW(Test a linear correlation between two samples.
