    ...
    for i in range(size):
        for j in range(observationDimension):
            for k in range(observationDimension):
                globalErrorCovariance[i * observationDimension + j, i * observationDimension + k] = localErrorCovariance[j,k]
...
for method in methods:
    ...
    globalErrorCovariance = local2globalCovariance(localErrorCovariance, sampleSize, outputDimension)
