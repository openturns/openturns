...
for testCase in range(len(distribution)):
    ...
    print("Minimum volume interval=", distribution[testCase].computeMinimumVolumeInterval(0.95, threshold))
    print("threshold=", threshold)
    beta = ot.NumericalPoint()
    levelSet = distribution[testCase].computeMinimumVolumeLevelSet(0.95, beta)
    print("Minimum volume level set=", levelSet)
    print("beta=", beta)
    print("Bilateral confidence interval=", distribution[testCase].computeBilateralConfidenceInterval(0.95, beta))
    print("beta=", beta)
    print("Unilateral confidence interval (lower tail)=", distribution[testCase].computeUnilateralConfidenceInterval(0.95, False, beta))
    print("beta=", beta)
    print("Unilateral confidence interval (upper tail)=", distribution[testCase].computeUnilateralConfidenceInterval(0.95, True, beta))
    print("beta=", beta)
