...
limitState.setGradient(ot.CenteredFiniteDifferenceGradient(ot.ResourceMap.GetAsScalar(
    "CenteredFiniteDifferenceGradient-DefaultEpsilon"), limitState.getEvaluation()))
limitState.setHessian(ot.CenteredFiniteDifferenceHessian(ot.ResourceMap.GetAsScalar(
...
myAlgoAR = ot.FORM(myAbdoRackwitz, myEvent, start + ot.Point(2, 1))
myAlgoAR2 = ot.SORM(myAbdoRackwitz, myEvent, start + ot.Point(2, 1))
