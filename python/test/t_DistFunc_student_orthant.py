...
sigma[1, 0] = 0.5
sigma[1, 1] = 2.0
L = sigma.computeCholesky()
p = ot.DistFunc.pStudentOrthantND([-1.0, -2.0], [1.0, 2.0], L, 10.0, 100, 0.5, 500)
...
sigma[1, 1] = 1.0
L = sigma.computeCholesky()
p = ot.DistFunc.pStudentOrthantND([-1.0, -1.0], [1.0, 1.0], [0.5, -0.5], L, 10.0, 100, 0.5, 500)
