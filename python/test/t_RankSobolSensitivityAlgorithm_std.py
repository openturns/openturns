...
assert_almost_equal(interval.getLowerBound(), [0.117529, 0.409689, -0.176039], 1.0e-4, 1.0e-2)
assert_almost_equal(interval.getUpperBound(), [0.340675, 0.560271, 0.0857027], 1.0e-4, 1.0e-2)
