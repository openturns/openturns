...
# by the finite difference technique
PDFgrFD = ot.Point(2)
PDFgrFD[0] = (ot.Logistic(distribution.getMu() + eps, distribution.getBeta()).computePDF(point) -
              ot.Logistic(distribution.getMu() - eps, distribution.getBeta()).computePDF(point)) / (2.0 * eps)
PDFgrFD[1] = (ot.Logistic(distribution.getMu(), distribution.getBeta() + eps).computePDF(point) -
              ot.Logistic(distribution.getMu(), distribution.getBeta() - eps).computePDF(point)) / (2.0 * eps)
...
CDFgrFD = ot.Point(2)
CDFgrFD[0] = (ot.Logistic(distribution.getMu() + eps, distribution.getBeta()).computeCDF(point) -
              ot.Logistic(distribution.getMu() - eps, distribution.getBeta()).computeCDF(point)) / (2.0 * eps)
CDFgrFD[1] = (ot.Logistic(distribution.getMu(), distribution.getBeta() + eps).computeCDF(point) -
              ot.Logistic(distribution.getMu(), distribution.getBeta() - eps).computeCDF(point)) / (2.0 * eps)
