...
PDFgrFD = ot.Point(2)
PDFgrFD[0] = (
    ot.Uniform(distribution.getA() + eps, distribution.getB()).computePDF(point)
    - ot.Uniform(distribution.getA() - eps, distribution.getB()).computePDF(point)
) / (2.0 * eps)
PDFgrFD[1] = (
    ot.Uniform(distribution.getA(), distribution.getB() + eps).computePDF(point)
    - ot.Uniform(distribution.getA(), distribution.getB() - eps).computePDF(point)
) / (2.0 * eps)
...
CDFgrFD = ot.Point(2)
CDFgrFD[0] = (
    ot.Uniform(distribution.getA() + eps, distribution.getB()).computeCDF(point)
    - ot.Uniform(distribution.getA() - eps, distribution.getB()).computeCDF(point)
) / (2.0 * eps)
CDFgrFD[1] = (
    ot.Uniform(distribution.getA(), distribution.getB() + eps).computeCDF(point)
    - ot.Uniform(distribution.getA(), distribution.getB() - eps).computeCDF(point)
) / (2.0 * eps)
