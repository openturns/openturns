...
myCobyla.setStartingPoint(myDistribution.getSigma())
...
myAbdoRackwitz.setStartingPoint(myDistribution.getSigma())
...
length90ISS = ResultISS.getProbabilityDistribution().computeBilateralConfidenceInterval(0.9)
...
length90IS = ResultIS.getProbabilityDistribution().computeBilateralConfidenceInterval(0.9)
ott.assert_almost_equal(PFIS, 0.00631, 0.0, 1e-5)
