...
ott.assert_almost_equal(test_result.getStatistic(), linear_model_analysis.getFisherScore(), 1e-13, 0)
ott.assert_almost_equal(test_result.getPValue(), linear_model_analysis.getFisherPValue(), 0, 0)
