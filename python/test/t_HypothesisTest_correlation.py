...
print('PartialPearsonXY=', ot.HypothesisTest.PartialPearson(
...
print('PartialPearsonX0Y=', ot.HypothesisTest.PartialPearson(
    sampleX, sampleY, selection2, 0.10))
print('PearsonX0Y=', ot.HypothesisTest.Pearson(sampleX0, sampleY, 0.10))
print('FullPearsonX0Y=', ot.HypothesisTest.FullPearson(
...
# Probability of the H0 reject zone : 0.10
print('FullPearsonXY=', ot.HypothesisTest.FullPearson(
    sampleX, sampleY, 0.10))
print('FullPearsonYY=', ot.HypothesisTest.FullPearson(
