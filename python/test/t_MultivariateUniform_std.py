...
ott.assert_almost_equal(ddf, [0.0, 0.0])
print("DDF OK")

# setA/setB
dist = otexp.MultivariateUniform([0.0, 0.0], [1.0, 1.0])
dist.setA([-1.0, -1.0])
ott.assert_almost_equal(dist.getA(), [-1.0, -1.0])
dist.setB([2.0, 2.0])
ott.assert_almost_equal(dist.getB(), [2.0, 2.0])
print("setA/setB OK")
...
ott.assert_almost_equal(param, [0.0, 1.0, 2.0, 5.0])

dist2 = otexp.MultivariateUniform([0.0, 0.0], [1.0, 1.0])
dist2.setParameter(param)
ott.assert_almost_equal(dist2.getA(), [0.0, 1.0])
ott.assert_almost_equal(dist2.getB(), [2.0, 5.0])
