...
constraintFun = ot.SymbolicFunction(["x","y","z","t"],["-(8*x + 5*y + 3*z + 2*t -10)"])
x = [0, 1, 1, 1]
...
problem.setVariablesType([ot.OptimizationProblemImplementation.BINARY, ot.OptimizationProblemImplementation.BINARY, ot.OptimizationProblemImplementation.BINARY, ot.OptimizationProblemImplementation.BINARY])
