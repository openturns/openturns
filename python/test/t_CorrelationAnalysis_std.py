...
ott.assert_almost_equal(squared_src_normalize, [0.9, 0.1], 0.0, 1e-2) # theoretical value

src = corr_analysis.computeSRC()
ott.assert_almost_equal(src, [0.9486832980505138, 0.31622776601683794], 0.0, 1e-2) # sqrt of squared_src
