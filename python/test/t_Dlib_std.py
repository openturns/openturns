...
notConstrainingBoundsProblem = ot.OptimizationProblem(rosenbrock, ot.Function(), ot.Function(), notConstrainingBounds)

constrainingBounds = ot.Interval([0.0, -2.0], [5.0, 0.5])
constrainingBoundsProblem = ot.OptimizationProblem(rosenbrock, ot.Function(), ot.Function(), constrainingBounds)
...
ott.assert_almost_equal(notConstrainingBoundsCg.getResult().getOptimalPoint(), unboundedPref, 5e-2)
ott.assert_almost_equal(constrainingBoundsCg.getResult().getOptimalPoint(), boundedPref, 5e-2)
ott.assert_almost_equal(unboundedBfgs.getResult().getOptimalPoint(), unboundedPref, 5e-2)
ott.assert_almost_equal(notConstrainingBoundsBfgs.getResult().getOptimalPoint(), unboundedPref, 5e-2)
ott.assert_almost_equal(constrainingBoundsBfgs.getResult().getOptimalPoint(), boundedPref, 5e-2)
ott.assert_almost_equal(unboundedLbfgs.getResult().getOptimalPoint(), unboundedPref, 5e-2)
ott.assert_almost_equal(notConstrainingBoundsLbfgs.getResult().getOptimalPoint(), unboundedPref, 5e-2)
ott.assert_almost_equal(constrainingBoundsLbfgs.getResult().getOptimalPoint(), boundedPref, 5e-2)
ott.assert_almost_equal(unboundedNewton.getResult().getOptimalPoint(), unboundedPref, 5e-2)
ott.assert_almost_equal(notConstrainingBoundsNewton.getResult().getOptimalPoint(), unboundedPref, 5e-2)
ott.assert_almost_equal(constrainingBoundsNewton.getResult().getOptimalPoint(), boundedPref, 5e-2)
ott.assert_almost_equal(unboundedTrustRegion.getResult().getOptimalPoint(), unboundedPref, 5e-2)
