...
PDFgrFD = ot.Point(2)
PDFgrFD[0] = (
    ot.Laplace(distribution.getMu() + eps, distribution.getLambda()).computePDF(point)
    - ot.Laplace(distribution.getMu() - eps, distribution.getLambda()).computePDF(point)
) / (2.0 * eps)
PDFgrFD[1] = (
    ot.Laplace(distribution.getMu(), distribution.getLambda() + eps).computePDF(point)
    - ot.Laplace(distribution.getMu(), distribution.getLambda() - eps).computePDF(point)
) / (2.0 * eps)
...
CDFgrFD = ot.Point(2)
CDFgrFD[0] = (
    ot.Laplace(distribution.getMu() + eps, distribution.getLambda()).computeCDF(point)
    - ot.Laplace(distribution.getMu() - eps, distribution.getLambda()).computeCDF(point)
) / (2.0 * eps)
CDFgrFD[1] = (
    ot.Laplace(distribution.getMu(), distribution.getLambda() + eps).computeCDF(point)
    - ot.Laplace(distribution.getMu(), distribution.getLambda() - eps).computeCDF(point)
) / (2.0 * eps)
