...
print("f=", f)
graph = f.draw(ot.Point(2, -10.0),
                ot.Point(2, 10.0), ot.Indices(2, 21))
print("graph=", graph)

# Full interfaces
f = ot.SymbolicFunction(["x0", "x1", "x2"], [
...
# point
graph2D = f.draw(1, 2, 1, centralPoint, ot.Point(
    2, -5.0), ot.Point(2, 5.0), ot.Indices(2, 21))
