...
PDFgrFD = ot.Point(1)
PDFgrFD[0] = (ot.Chi(distribution.getNu() + eps).computePDF(point) -
              ot.Chi(distribution.getNu() - eps).computePDF(point)) / (2.0 * eps)
print("pdf gradient (FD)=", repr(PDFgrFD))
CDFgr = distribution.computeCDFGradient(point)
print("cdf gradient     =", repr(CDFgr))
CDFgrFD = ot.Point(1)
CDFgrFD[0] = (ot.Chi(distribution.getNu() + eps).computeCDF(point) -
              ot.Chi(distribution.getNu() - eps).computeCDF(point)) / (2.0 * eps)
