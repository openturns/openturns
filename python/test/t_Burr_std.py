...
PDFgrFD = ot.Point(2)
PDFgrFD[0] = (ot.Burr(distribution.getC() + eps, distribution.getK()).computePDF(point) -
              ot.Burr(distribution.getC() - eps, distribution.getK()).computePDF(point)) / (2.0 * eps)
PDFgrFD[1] = (ot.Burr(distribution.getC(), distribution.getK() + eps).computePDF(point) -
              ot.Burr(distribution.getC(), distribution.getK() - eps).computePDF(point)) / (2.0 * eps)
print("pdf gradient (FD)=", repr(PDFgrFD))
CDFgr = distribution.computeCDFGradient(point)
print("cdf gradient     =", repr(CDFgr))
CDFgrFD = ot.Point(2)
CDFgrFD[0] = (ot.Burr(distribution.getC() + eps, distribution.getK()).computeCDF(point) -
              ot.Burr(distribution.getC() - eps, distribution.getK()).computeCDF(point)) / (2.0 * eps)
CDFgrFD[1] = (ot.Burr(distribution.getC(), distribution.getK() + eps).computeCDF(point) -
              ot.Burr(distribution.getC(), distribution.getK() - eps).computeCDF(point)) / (2.0 * eps)
