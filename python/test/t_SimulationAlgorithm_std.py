...
result = ot.ProbabilitySimulationResult(event_algo.getResult())
...
expect_result = ot.ExpectationSimulationResult(expect_algo.getResult())
...
sobol_result = ot.SobolSimulationResult(sobol_algo.getResult())
