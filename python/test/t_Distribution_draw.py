...
ot.Distribution(distND).getPDF().drawCrossCuts(ot.Point(5, 0.), ot.Point(5, -4.0), ot.Point(5, 4.0), ot.Indices(5, 10), 0., 1.)
# log-PDF
...
ot.Distribution(distND).getCDF().drawCrossCuts(ot.Point(5, 0.), ot.Point(5, -4.0), ot.Point(5, 4.0), ot.Indices(5, 10), 0., 1., False, True)
# Quantile
