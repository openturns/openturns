...
ot.Distribution(distND).getPDF().drawCrossCuts(ot.Point(5, 0.0), ot.Point(5, -4.0), ot.Point(5, 4.0), ot.Indices(5, 10), True, False, 0.0, 1.0)
# log-PDF
...
ot.Distribution(distND).getCDF().drawCrossCuts(ot.Point(5, 0.0), ot.Point(5, -4.0), ot.Point(5, 4.0), ot.Indices(5, 10), False, True, 0.0, 1.0)
# Quantile
