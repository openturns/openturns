...
# by the finite difference technique
PDFgrFD = ot.Point(2)
PDFgrFD[0] = (ot.SquaredNormal(distribution.getMu() + eps, distribution.getSigma()).computePDF(point) -
              ot.SquaredNormal(distribution.getMu() - eps, distribution.getSigma()).computePDF(point)) / (2.0 * eps)
PDFgrFD[1] = (ot.SquaredNormal(distribution.getMu(), distribution.getSigma() + eps).computePDF(point) -
              ot.SquaredNormal(distribution.getMu(), distribution.getSigma() - eps).computePDF(point)) / (2.0 * eps)
...
CDFgrFD = ot.Point(2)
CDFgrFD[0] = (ot.SquaredNormal(distribution.getMu() + eps, distribution.getSigma()).computeCDF(point) -
              ot.SquaredNormal(distribution.getMu() - eps, distribution.getSigma()).computeCDF(point)) / (2.0 * eps)
CDFgrFD[1] = (ot.SquaredNormal(distribution.getMu(), distribution.getSigma() + eps).computeCDF(point) -
              ot.SquaredNormal(distribution.getMu(), distribution.getSigma() - eps).computeCDF(point)) / (2.0 * eps)
