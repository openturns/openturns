...
# Set some hmat parameters
ResourceMap.SetAsNumericalScalar("HMatrix-AssemblyEpsilon", 5.e-9)
ResourceMap.SetAsNumericalScalar("HMatrix-RecompressionEpsilon", 5.e-9)
