...
try:
    ...
    print("FAIL: expected exception for negative data")
except Exception as e:
    print("OK: negative data rejected, msg=", str(e)[:50])
...
try:
    ...
    factory.build(badSample)
    print("FAIL: expected exception for invalid moments")
except Exception as e:
    print("OK: invalid moments rejected, msg=", str(e)[:50])
