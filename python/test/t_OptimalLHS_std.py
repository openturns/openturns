...
optimalLHSAlgorithm = ot.SimulatedAnnealingLHS(lhs, geomProfile, spaceFillingC2)
print("lhs=", optimalLHSAlgorithm)
design = optimalLHSAlgorithm.generate()
...
optimalLHSAlgorithm = ot.SimulatedAnnealingLHS(lhs, linearProfile, spaceFillingC2)
print("lhs=", optimalLHSAlgorithm)
design = optimalLHSAlgorithm.generate()
...
optimalLHSAlgorithm = ot.SimulatedAnnealingLHS(lhs, linearProfile, spaceFillingPhiP)
print("lhs=", optimalLHSAlgorithm)
design = optimalLHSAlgorithm.generate()
