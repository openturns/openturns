...
PDFgrFD = ot.Point(2)
PDFgrFD[0] = (
    ot.LogUniform(distribution.getALog() + eps, distribution.getBLog()).computePDF(
        point
    )
    - ot.LogUniform(distribution.getALog() - eps, distribution.getBLog()).computePDF(
        point
...
PDFgrFD[1] = (
    ot.LogUniform(distribution.getALog(), distribution.getBLog() + eps).computePDF(
        point
    )
    - ot.LogUniform(distribution.getALog(), distribution.getBLog() - eps).computePDF(
        point
...
CDFgrFD = ot.Point(2)
CDFgrFD[0] = (
    ot.LogUniform(distribution.getALog() + eps, distribution.getBLog()).computeCDF(
        point
    )
    - ot.LogUniform(distribution.getALog() - eps, distribution.getBLog()).computeCDF(
        point
...
CDFgrFD[1] = (
    ot.LogUniform(distribution.getALog(), distribution.getBLog() + eps).computeCDF(
        point
    )
    - ot.LogUniform(distribution.getALog(), distribution.getBLog() - eps).computeCDF(
        point
