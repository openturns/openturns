...
distribution = ot.LogUniform(-0.5, 1.5)
...
# by the finite difference technique
PDFgrFD = ot.Point(2)
PDFgrFD[0] = (ot.LogUniform(distribution.getALog() + eps, distribution.getBLog()).computePDF(point) -
              ot.LogUniform(distribution.getALog() - eps, distribution.getBLog()).computePDF(point)) / (2.0 * eps)
PDFgrFD[1] = (ot.LogUniform(distribution.getALog(), distribution.getBLog() + eps).computePDF(point) -
              ot.LogUniform(distribution.getALog(), distribution.getBLog() - eps).computePDF(point)) / (2.0 * eps)
...
CDFgrFD = ot.Point(2)
CDFgrFD[0] = (ot.LogUniform(distribution.getALog() + eps, distribution.getBLog()).computeCDF(point) -
              ot.LogUniform(distribution.getALog() - eps, distribution.getBLog()).computeCDF(point)) / (2.0 * eps)
CDFgrFD[1] = (ot.LogUniform(distribution.getALog(), distribution.getBLog() + eps).computeCDF(point) -
              ot.LogUniform(distribution.getALog(), distribution.getBLog() - eps).computeCDF(point)) / (2.0 * eps)
