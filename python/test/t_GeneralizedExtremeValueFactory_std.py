...
cov_ref = [[0.000816453, -0.00115985, 0.000123538, -0.00129949],
...
ott.assert_almost_equal(ot.Matrix(estimator_timevar.getParameterDistribution().getCovariance()), ot.Matrix(cov_ref), 2e-3, 1e-5)
