...
- polynomials: the associated distribution :math:`\mu_i` can be continuous
  ...
  polynomial family (see :class:`~openturns.experimental.UniVariateDistributionPolynomialFactory`).
...
.. topic:: API:
    ...
    - See :class:`~openturns.experimental.UniVariateDistributionPolynomialFactory`
