...
| With the notations
  ...
  .. math::
     ...
     \begin{aligned}
         \mu_\sampleSize &=& \frac{1}{\sampleSize}\sum_{i=1}^\sampleSize \mathbf{1}_{\{g(\underline{x}_i)) \leq 0 \}}\\
         \sigma_\sampleSize^2 &=& \frac{1}{\sampleSize}\sum_{i=1}^\sampleSize (\mathbf{1}_{\{g(\underline{x}^i)) \leq 0 \}} - \mu_\sampleSize)^2
       \end{aligned}
