...
Each Sobol' index is a part of the previous interaction indices.
...
+--------------------------------------+--------------------------------------------------+
| Total group interaction              | :math:`S_{\{1,2\}} + S_{\{1, 2, 3\}}`            |
+--------------------------------------+--------------------------------------------------+
| Group, first order (closed)          | :math:`S_{1} + S_{2} + S_{\{1, 2\}}`             |
+--------------------------------------+--------------------------------------------------+
| Group, total                         | :math:`S_1 + S_2 + S_{\{1, 2\}} + S_{1, 2, 3\}}` |
+--------------------------------------+--------------------------------------------------+
