...
# %%
# The results seem to indicate that the linear hypothesis can be accepted. Indeed, `R-Squared` value is nearly `1`. Furthermore, the adjusted value, which takes into account the data set size and the number of hyperparameters, is similar to `R-Squared`. 
#
