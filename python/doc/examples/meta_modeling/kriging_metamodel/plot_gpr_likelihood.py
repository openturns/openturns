"""
Gaussian process fitter : draw the likelihood
=============================================
"""
...
# parameter of a covariance Gaussian Process Regression model.
...
# %%
# We are now ready to build the Gaussian Process fitter algorithm, run it and store the result :
...
reducedLogLikelihoodFunction = algo.getObjectiveFunction()
