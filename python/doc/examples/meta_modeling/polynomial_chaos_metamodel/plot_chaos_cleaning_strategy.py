...
# %%
#
# The next function computes the polynomial chaos :math:`Q^2` score using simple validation
...
# will be required in order to produce a polynomial chaos expansion with :math:`Q^2`
...
# relative factor and returns the :math:`Q^2` score.
...
# coefficients among the first 101 ones. Let us see the :math:`Q^2` score and the
...
# produce the best :math:`Q^2` score.
