...
# %%
# The `IshigamiModel` data class contains the input distribution of the random vector :math:`\vect{X}=\Tr{(X_1, X_2, X_3)}` in `im.distributionX` and the Ishigami function in `im.model`.
