...
# %%
# In this example, we create some distributions conditionned by a particular value of its marginals.
#
...
#
# We condition the marginal :math:`X_1` to be simultaneously equal to its quantiles of order
# 0.05, 0.5 and 0.95. Then, we draw the resulting conditioned distribution of:
# .. math::
#
#    X_0 | X_1 = x_1
#
...
# all the conditioned distribution, whose PDF we draw on the same graph.
#
...
#
# We condition the marginal :math:`X_1` to be simultaneously equal to its quantiles of order
# 0.05, 0.5 and 0.95. Then, we draw the resulting bivariate conditioned distribution of:
# .. math::
#
#    (X_0,X_2) | X_1 = x_1
#
...
# but inside the theoretical range which is :math:`\Rset^2`.
#
