...
def plot_sample_by_kernel_smoothing(
    ...
    """
    Plot the estimated distribution of a linear-regression estimator.
    ...
    ----------
    sample_size : int
        The sample size used to fit each linear model.
    true_standard_deviation : float
        True standard deviation of the observation noise.
    coefficients : sequence of float
        True linear-model coefficients (including intercept).
    estimator : str
        Estimator selector: "variance", "standard-deviation", or "coefficient_i".
    repetitions_size : int
        The number of repetitions of the experiments.
        This is the (children) size of the sample of the biased
        sample variance
    true_value : float
        Exact value used to draw the reference vertical line.
    description : str
        Label for the sampled estimator.
