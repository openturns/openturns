"""
Create a polynomial chaos metamodel by integration on the cantilever beam-v2
============================================================================
"""
# %% 

# %%
# In this example, we create a polynomial chaos metamodel by integration on the cantilever beam example (see :ref:`use-case-cantilever-beam`).
#
