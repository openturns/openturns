"""
Kriging the cantilever beam model-v2
====================================
"""
# %%
# In this example, we create a kriging metamodel of the cantilever beam (see :ref:`use-case-cantilever-beam`). We use a squared exponential covariance model for the kriging. In order to estimate the hyper-parameters, we use a design of experiments which size is 20.
