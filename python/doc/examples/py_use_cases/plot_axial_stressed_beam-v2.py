...
# %%
# In this example, we compare four methods to estimate the probability in the axial stressed beam example :ref:`use-case-stressed-beam` :
#
...
# %%
R_dist = uc_beam.distribution_R #ot.LogNormalMuSigma(300.0, 30.0, 0.0).getDistribution()
...
# %%
F_dist = uc_beam.distribution_F #ot.Normal(75000., 5000.)
...
# %%
myDistribution = uc_beam.distribution #ot.ComposedDistribution([R_dist, F_dist])
myDistribution.setName('myDist')
