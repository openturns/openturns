"""
Estimate quantile confidence interval quantile from data
========================================================
"""

# %%
# In this example, we introduce use two methods to estimate confidence intervals of the
# :math:`\alpha` level quantile (:math:`\alpha \in [0,1]`) for an example found in [meeker2017]_.
...
# %%
# Estimate bilateral rank (indices are given in [0, n-1] whereas the book gives them in [1, n])
n = len(sample)
l, u = algo.computeBilateralRank(n)
print(f"l={l} u={u}")

# %%
# Estimate the bilateral confidence interval of the 0.1 quantile
...
# %%
# Estimate the one-sided rank for the upper side (in [0, n-1])
