"""
Use the FORM - SORM algorithms on non linear function
=====================================================
"""
# %%
...
# %%
# To get a first idea of the failure probability with reduced simulation budget, one can use the First Order Realibily Method.
