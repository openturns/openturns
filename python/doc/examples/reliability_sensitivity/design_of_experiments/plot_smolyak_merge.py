...
ot.ResourceMap.SetAsScalar("SmolyakExperiment-DefaultPointRelativeEpsilon", 1.e-8)
ot.ResourceMap.SetAsScalar("SmolyakExperiment-DefaultPointAbsoluteEpsilon", 1.e-8)
level_list = list(range(1, 10))
size_decrease_list = []
for level in level_list:
