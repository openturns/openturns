...
if (!Scorer) {
  ...
  var Scorer = {
    ...
    score: function(result) {
      ...
      else if (result[0].includes("auto")){
        var myscore = 300;
      }
      else{
        var myscore = -1;
  ...
  query : function(query) {
    ...
    if (Scorer.score) {
      for (i = 0; i < results.length; i++){
        ...
        if( localScore >= 300){
          CATEGORY_PREFIX = 'Examples : ';  
        }
        else if( localScore >= 200){
          CATEGORY_PREFIX = 'API      : ';  
        }
        else if(localScore >= 100){
          CATEGORY_PREFIX = 'Theory   : ';  
        }
        results[i][1] = CATEGORY_PREFIX + results[i][1];
