...
pdf_2d = ot.Graph("MultivariateHypergeometric, PDF", "x1", "x2")
cdf_2d = ot.Graph("MultivariateHypergeometric, CDF", "x1", "x2")

distribution_2d = otexp.MultivariateHypergeometric(10, [10, 12])
...
grid.setTitle("MultivariateHypergeometric")
